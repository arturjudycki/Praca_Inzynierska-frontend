...
const LoginSchemat = Yup.object().shape({
  username: Yup.string()
    .required("Nazwa admina jest wymagana!")
    .min(5, "Nazwa admina musi składać się z conajmniej 5 znaków.")
    .max(20, "Nazwa admina może składać się maksymalnie z 20 znaków"),
    ...
    content = (
      <section className="popUp popUp--wider">
        <div class="popUp__register201">
          <p>Konto admina zostało pomyślnie utworzone.</p>
          <NavLink>
            <button
              onClick={() => {
                navigate("/create-accounts-admin");
                navigate(0);
              }}
...
export default CreateAccountsAdmin;
